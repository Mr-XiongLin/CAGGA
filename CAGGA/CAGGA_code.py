...
from getStrlearndata import getStrlearnstream
from getSKmultiflowdata import getmultiflowStreams
from getOpenMLdata import getOpenMLData
from unit import HIC, softmax
...
class CAGGA(object):
    ...
    def predict(self,X_input):
        ...
        # probas = np.asarray([clf.predict_proba(X_input)[:,-1] for clf in self.Classifiers])
        return np.argmax(softmax(probas.sum(axis=0)))
